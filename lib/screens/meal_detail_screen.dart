...
class MealDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final selectedMeal = DUMMY_MEALS.firstWhere((object) => object.id == mealId);
    var accentColor = Theme.of(context).colorScheme.secondary;
    bool isLandScape = MediaQuery.of(context).orientation == Orientation.landscape;
    var lan=Provider.of<LanguageProvider>(context,listen: true);
    List<String> ingredientList=lan.getTexts('ingredients-$mealId') as List<String>;
    ...
    Widget titleSection(BuildContext ctx, String text) {
      return Container(
        ...
        child: Text(
          lan.getTexts(text).toString(), style: Theme.of(ctx).textTheme.headline6,textAlign: TextAlign.center,),
      );
    }
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          child: Icon(
            Provider.of<MealProvider>(context, listen: true).isFavorite(mealId) ? Icons.star
                : Icons.star_border,
          ),
          onPressed: () {
